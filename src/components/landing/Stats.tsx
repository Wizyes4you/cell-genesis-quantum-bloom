  ...
  return (
    <section id="stats" className="py-20 sm:py-32">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-4xl sm:text-5xl font-bold mb-4">النظام البيئي في نمو مستمر</h2>
        <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
          هدفنا هو الوصول إلى 8 مليار خلية، لتمثل كل إنسان على وجه الأرض.
        </p>
        <div className="max-w-4xl mx-auto bg-secondary/50 p-8 rounded-2xl border border-border shadow-2xl">
          <h3 className="text-2xl font-semibold text-primary">الخلايا النشطة حالياً</h3>
          <p className="text-6xl sm:text-7xl font-mono font-bold my-4 tracking-wider">
            {currentCells.toLocaleString('ar-EG')}
          </p>
          ...
          <p className="text-muted-foreground">
            {progressPercentage.toFixed(4)}% من الهدف النهائي
          </p>
        </div>
      </div>
    </section>
